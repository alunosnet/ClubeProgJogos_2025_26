...
public static class Utils 
{
	...
	public static bool isInFront(GameObject me,GameObject obj)
    {
        return Vector3.Dot(Vector3.forward, me.transform.InverseTransformPoint(obj.transform.position)) > 0;
    }
}
